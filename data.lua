...
private.data.races = {
    ...
    arakkoa = {
        ...
        artifacts = {
            ...
            { spell = 168329, item = 114205, rarity = "common", patch = 60000, pristine = { item = 114223, quest =  36779 }, crate = true }, -- Apexis Hieroglyph
            { spell = 168330, item = 114206, rarity = "common", patch = 60000, pristine = { item = 114224, quest =  36780 }, crate = true }, -- Apexis Scroll
            { spell = 168331, item = 117382, rarity =   "rare", patch = 60000 },                                                             -- Beakbreaker of Terokk
            { spell = 168322, item = 114198, rarity = "common", patch = 60000, pristine = { item = 114216, quest =  36772 }, crate = true }, -- Burial Urn
            { spell = 168323, item = 114199, rarity = "common", patch = 60000, pristine = { item = 114217, quest =  36773 }, crate = true }, -- Decree Scrolls
            { spell = 168321, item = 114197, rarity = "common", patch = 60000, pristine = { item = 114215, quest =  36771 }, crate = true }, -- Dreamcatcher
            { spell = 168327, item = 114203, rarity = "common", patch = 60000, pristine = { item = 114221, quest =  36777 }, crate = true }, -- Outcast Dreamcatcher
            { spell = 168324, item = 114200, rarity = "common", patch = 60000, pristine = { item = 114218, quest =  36774 }, crate = true }, -- Solar Orb
            { spell = 168325, item = 114201, rarity = "common", patch = 60000, pristine = { item = 114219, quest =  36775 }, crate = true }, -- Sundial
            { spell = 168326, item = 114202, rarity = "common", patch = 60000, pristine = { item = 114220, quest =  36776 }, crate = true }, -- Talonpriest Mask
        },
    },
    draenorclans = {
        id = 350,
        ...
        artifacts = {
            ...
            { spell = 168301, item = 114163, rarity = "common", patch = 60000, pristine = { item = 114164, quest =  36753 }, crate = true }, -- Barbed Fishing Hook
            { spell = 168298, item = 114157, rarity = "common", patch = 60000, pristine = { item = 114158, quest =  36750 }, crate = true }, -- Blackrock Razor
            { spell = 168302, item = 114165, rarity = "common", patch = 60000, pristine = { item = 114166, quest =  36754 }, crate = true }, -- Calcified Eye in a Jar
            { spell = 168303, item = 114167, rarity = "common", patch = 60000, pristine = { item = 114168, quest =  36755 }, crate = true }, -- Ceremonial Tattoo Needles
            { spell = 168304, item = 114169, rarity = "common", patch = 60000, pristine = { item = 114170, quest =  36757 }, crate = true }, -- Cracked Ivory Idol
            { spell = 168308, item = 114177, rarity = "common", patch = 60000, pristine = { item = 114178, quest =  36760 }, crate = true }, -- Doomsday Prophecy
            { spell = 168297, item = 114155, rarity = "common", patch = 60000, pristine = { item = 114156, quest =  36749 }, crate = true }, -- Elemental Bellows
            { spell = 168290, item = 114141, rarity = "common", patch = 60000, pristine = { item = 114142, quest =  36725 }, crate = true }, -- Fang-Scarred Frostwolf Axe
            { spell = 168306, item = 114173, rarity = "common", patch = 60000, pristine = { item = 114174, quest =  36758 }, crate = true }, -- Flask of Blazegrease
            { spell = 168291, item = 114143, rarity = "common", patch = 60000, pristine = { item = 114144, quest =  36743 }, crate = true }, -- Frostwolf Ancestry Scrimshaw
            { spell = 168307, item = 114175, rarity = "common", patch = 60000, pristine = { item = 114176, quest =  36759 }, crate = true }, -- Gronn-Tooth Necklace
            { spell = 172459, item = 116985, rarity =   "rare", patch = 60000 },                                                             -- Headdress of the First Shaman
            { spell = 168300, item = 114161, rarity = "common", patch = 60000, pristine = { item = 114162, quest =  36752 }, crate = true }, -- Hooked Dagger
            { spell = 168296, item = 114153, rarity = "common", patch = 60000, pristine = { item = 114154, quest =  36748 }, crate = true }, -- Metalworker's Hammer
            { spell = 168294, item = 114149, rarity = "common", patch = 60000, pristine = { item = 114150, quest =  36746 }, crate = true }, -- Screaming Bullroarer
            { spell = 168293, item = 114147, rarity = "common", patch = 60000, pristine = { item = 114148, quest =  36745 }, crate = true }, -- Warsinger's Drums
            { spell = 168295, item = 114151, rarity = "common", patch = 60000, pristine = { item = 114152, quest =  36747 }, crate = true }, -- Warsong Ceremonial Pike
            { spell = 168299, item = 114159, rarity = "common", patch = 60000, pristine = { item = 114160, quest =  36751 }, crate = true }, -- Weighted Chopping Axe
            { spell = 168292, item = 114145, rarity = "common", patch = 60000, pristine = { item = 114146, quest =  36744 }, crate = true }, -- Wolfskin Snowshoes
        },
    },
    ogre = {
        id = 382,
        ...
        artifacts = {
            ...
            { spell = 168318, item = 114194, rarity = "common", patch = 60000, pristine = { item = 114213, quest =  36770 }, crate = true }, -- Imperial Decree Stele
            { spell = 168314, item = 114190, rarity = "common", patch = 60000, pristine = { item = 114209, quest =  36766 }, crate = true }, -- Mortar and Pestle
            { spell = 168311, item = 114185, rarity = "common", patch = 60000, pristine = { item = 114186, quest =  36763 }, crate = true }, -- Ogre Figurine
            { spell = 168312, item = 114187, rarity = "common", patch = 60000, pristine = { item = 114188, quest =  36764 }, crate = true }, -- Pictogram Carving
            { spell = 168317, item = 114193, rarity = "common", patch = 60000, pristine = { item = 114212, quest =  36769 }, crate = true }, -- Rylak Riding Harness
            { spell = 168319, item = 117385, rarity =   "rare", patch = 60000 },                                                             -- Sorcerer-King Toe Ring
            { spell = 168316, item = 114192, rarity = "common", patch = 60000, pristine = { item = 114211, quest =  36768 }, crate = true }, -- Stone Dentures
            { spell = 168310, item = 114183, rarity = "common", patch = 60000, pristine = { item = 114184, quest =  36762 }, crate = true }, -- Stone Manacles
            { spell = 168309, item = 114181, rarity = "common", patch = 60000, pristine = { item = 114182, quest =  36761 }, crate = true }, -- Stonemaul Succession Stone
    ...
    highborne = {
        ...
        artifacts = {
            ...
            { spell = 196473, item = 130909, rarity = "common", patch = 70000, pristine = { item = 130924, quest =  40352 }, crate = true }, -- Pre-War Highborne Tapestry
            { spell = 196472, item = 130908, rarity = "common", patch = 70000, pristine = { item = 130923, quest =  40351 }, crate = true }, -- Quietwine Vial
            { spell = 196470, item = 130906, rarity = "common", patch = 70000, pristine = { item = 130921, quest =  40349 }, crate = true }, -- Violetglass Vessel
    ...
    highmountaintauren = {
        ...
        artifacts = {
            ...
            { spell = 196476, item = 130912, rarity = "common", patch = 70000, pristine = { item = 130927, quest =  40355 }, crate = true }, -- Moosebone Fish-Hook
            { spell = 196479, item = 130915, rarity = "common", patch = 70000, pristine = { item = 130930, quest =  40358 }, crate = true }, -- Stonewood Bow
            { spell = 196475, item = 130911, rarity = "common", patch = 70000, pristine = { item = 130926, quest =  40354 }, crate = true }, -- Trailhead Drum
            { spell = 223851, item = 131733, rarity =   "rare", patch = 70000, rareQuest = 41188 },                                          -- Spear of Rethu
            { spell = 223852, item = 131736, rarity =   "rare", patch = 70000, rareQuest = 41191 },                                          -- Prizerock Neckbacnd
            { spell = 223853, item = 131734, rarity =   "rare", patch = 70000, rareQuest = 41193 },                                          -- Spirit of Eche'ro
        },
    },
    demonic = {
        id = 408,
        ...
        artifacts = {
            ...
            { spell = 196480, item = 130916, rarity = "common", patch = 70000, pristine = { item = 130931, quest =  40359 }, crate = true }, -- Imp's Cup
            { spell = 196482, item = 130918, rarity = "common", patch = 70000, pristine = { item = 130933, quest =  40361 }, crate = true }, -- Malformed Abyssal
            { spell = 196483, item = 130919, rarity = "common", patch = 70000, pristine = { item = 130934, quest =  40362 }, crate = true }, -- Orb of Inner Chaos
            { spell = 223854, item = 131724, rarity =   "rare", patch = 70000, rareQuest = 41157 },                                          -- Crystalline Eye of Undravius
            { spell = 223855, item = 131735, rarity =   "rare", patch = 70000, rareQuest = 41802 },                                          -- Imp Generator
            { spell = 223856, item = 136922, rarity =   "rare", patch = 70000, rareQuest = 41163 },                                          -- Wyrmy Tunkins
            { spell = 223857, item = 131743, rarity =   "rare", patch = 70000, rareQuest = 41166 },                                          -- Blood of Young Mannoroth
